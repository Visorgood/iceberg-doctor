...
| **R9** | **Diagnose.** Run health checks and report findings with severity, the evidence behind each, estimated reclaimable bytes, and the command that would fix it. | DE, PE | manifest lists | v0.1 |
